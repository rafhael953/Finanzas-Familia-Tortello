...
export const api = {
  ...
  ajustarSaldoDeuda: (categoria, saldoHoy) =>
    request("/api/deudas/ajustar-saldo", { method: "PUT", body: JSON.stringify({ categoria, saldoHoy }) }),
...
export const ETIQUETAS_CATEGORIA = {
  ...
  auteco: "Auteco (moto)",
  numama: "NU mamá",
  nohora: "Nohora (saldada)",
  bancolombia: "Bancolombia (saldada)",
  nu: "Ahorro NU",
  xtb: "Inversión XTB",
